...
func (rc *Cache) associate(originKey interface{}) string {
	...
	return fmt.Sprintf("%s:%s", originKey, rc.key)
}
...
func (rc *Cache) Put(ctx context.Context, key string, val interface{}, timeout time.Duration) (err error) {
	if timeout <= 0 {
